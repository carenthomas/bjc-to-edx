...
rachelH = {
    ...
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.rachel.txt'}
...
KunalMarwaha = { name: 'Kunal Marwaha',
    ...
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.kunal.txt'}
...
benC = { name: 'Ben Carvalho',
    ...
    email: 'bencarvalho1@berkeley.edu',
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.ben.txt' }
...
pierce = { name: 'Pierce Vollucci',
    ...
    email: 'pavtheway007@berkeley.edu',
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.pierce.txt'}

mridula = {name: 'Mridula Dilip',
    img: 'Sp14/MrindulaDilip.jpg',
    imgSrc: 'MrindulaDilip.jpg' }

veer = {name: 'Veersuvrat Rajpal',
    img: 'Sp14/VeersuvratRajpal.jpg',
    imgSrc: 'VeersuvratRajpal.jpg',
    email: 'veersuvrat@berkeley.edu',
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.veer.txt'}

adamK = {name: 'Adam Kuphaldt',
    img: 'Sp14/AdamKuphaldt.jpg',
    imgSrc: 'AdamKuphaldt.jpg',
    email: 'akuphaldt@berkeley.edu',
    bio: 'http://edge.edx.org/c4x/BerkeleyX/CS__10/asset/bio.adam.txt'}
/*****************************************************************************/
/** LIST DEFINITIONS **/
/*****************************************************************************/
...
las = [ 'Arany Uthayakumar',
        ...
        'Edward Jiang',
        'Elizabeth Steger',
        'Jeffrey Bruce Jacinto',
        'Jenny Wang',
        'Jiawei Jiang',
        'Jobel Kyle Petallana Vecino',
        'Luis Vasquez',
        'Luke Karl',
        'Mason Fujimoto',
        'Michelle Tsai',
...
function imgError(image){
    image.src = 'https://inst.eecs.berkeley.edu/~cs10/images/NPY3D.jpg';
}
...
function buildPerson(data, width) {
    ...
    elm = '<div style="display:table-cell; padding-right:20px">'
    if (!!data.img) {
